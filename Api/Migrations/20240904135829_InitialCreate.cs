        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Regions_Brands_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dealerships_Locales_LocaleId",
                        column: x => x.LocaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAccess_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserAccess_Dealerships_DealershipId",
                        column: x => x.DealershipId,
                        principalTable: "Dealerships",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserAccess_Manufacturers_ManufacturerId",
                        column: x => x.ManufacturerId,
                        principalTable: "Manufacturers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Regions_BrandId",
                table: "Regions",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAccess_BrandId",
                table: "UserAccess",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAccess_DealershipId",
                table: "UserAccess",
                column: "DealershipId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAccess_ManufacturerId",
                table: "UserAccess",
                column: "ManufacturerId");
